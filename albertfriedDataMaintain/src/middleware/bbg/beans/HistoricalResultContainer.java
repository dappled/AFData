 ...
 */
public class HistoricalResultContainer implements I_ResultContainer<HashMap<String, ? extends TimeSeries<? extends TimeUnit>>> {
	private RequestType													_type;
	private HashMap<String, ? extends TimeSeries<? extends TimeUnit>>	_solutions;
	private Set<String>													_underlyings;
	private int															_finished;

	public HistoricalResultContainer(RequestType type, Set<String> names) throws Exception {
		_type = type;
	...
	public HistoricalResultContainer(String type, Set<String> names) throws Exception {
