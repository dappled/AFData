...
public class DateUtils {
	...
	public static String todayString() {
		...
		ret = ret.replaceAll( "-", "" );
		return DateUtils.standardFromyyyyMMdd( ret );
	}
	...
	public static String standardFromyyyyMMdd(final String date) {
		try {
			return DateUtils.standardFromMMddyyyy( date.substring( 4, 8 ) + date.substring( 0, 4 ) );
	...
	public static String standardFromStringMonthTypeOne(final String date) {
		try {
			...
			return DateUtils.fillDigitalString( DateUtils.getMonth( list[ 0 ] ) ) + "/"
	...
	public static String standardFromStringMonthTypeTwo(final String date) {
		try {
			final String[] list = date.split( " " );
			return DateUtils.fillDigitalString( DateUtils.getMonth( list[ 1 ] ) ) + "/"
	...
	public static String standardFromyyyyBMMBdddd(final String date) {
		try {
			return DateUtils.standardFromyyyyMMdd( date.replace( "-", "" ) );
		} catch (final Exception e) {
			e.printStackTrace();
			System.err.printf( "Failed to parse date to MM/dd/yyyy from %s, will return empty string\n", date );
			return "";
	...
	public static String getPreviousWorkingDay(final String date) {
		...
		} while (dayOfWeek == Calendar.SATURDAY || dayOfWeek == Calendar.SUNDAY || DateUtils.isHoliday( cal ));
	...
	public static LocalDate GetExpDayFromDate(LocalDate date) {
		int fridayCount = 0;
	...
	public static void main(String[] args) {
		...
		System.out.println( GetExpDayFromDate( new LocalDate( 2014, 12, 1 ) ) );
